...
def display_about_me():
    ...
    st.write("""
    Below you can find some of my skills and tools i have workied with.
    """)
    ...
    with st.container():
        technologies_tools = [
            ...
            "Git, Jupyter Notebook, VS Code,Pycharm"
        ]
        for tech_tool in technologies_tools:
            st.success(f"- {tech_tool}")
